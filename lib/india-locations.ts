...
export const INDIA_DISTRICTS: Record<string, string[]> = {
  'Andhra Pradesh': [
    ...
    'Kakinada', 'Krishna', 'Kurnool', 'Manyam', 'NTR', 'Nandyal', 'Nellore',
  ...
  'Chhattisgarh': [
    ...
    'Jagdalpur', 'Janjgir-Champa', 'Jashpur', 'Kabirdham', 'Kanker',
    'Khairagarh', 'Kondagaon', 'Korba', 'Koriya', 'Mahasamund', 'Manendragarh',
    'Mohla-Manpur', 'Mungeli', 'Narayanpur', 'Raigarh', 'Raipur', 'Rajnandgaon',
  ...
  'Haryana': [
    ...
    'Mahendragarh', 'Mewat', 'Nuh', 'Panchkula', 'Panipat', 'Palwal',
  ...
  'Sikkim': [
    'East Sikkim', 'Gyalshing', 'North Sikkim', 'Pakyong', 'Soreng', 'South Sikkim',
  ],
  'Tamil Nadu': [
